	...
	*/
	...
	$contact_email = 'cafox@pnw.edu'; //modified
...
//localhost/8888 to localhost/
	define ('BASE_URI', '/var/www/html/450/');
	define ('BASE_URL', '');
...
//end
	...
	function my_error_handler ($e_number, $e_message, $e_file, $e_line, $e_vars) {
		...
		if (!$live) { // Show the error in the browser.
			...
			error_log ($message, 1, $contact_email, 'From:mnfitzge@pnw.edu'); //modified
