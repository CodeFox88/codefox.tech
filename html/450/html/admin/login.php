...
?>
	   ...
	   <div id="header">
	      <div class="container">
		 <div class="wrapper">
		    <div class="logo"><h1><a href="./logout_home.php">Life Escape - Admin Login</a><span>Leave your uneventful life behind</span><span>and immerse yourself in amazing games!</span></h1>
		    </div>
	         </div>

         <ul class="nav">
			<!-- MENU -->
			<li><a href="/450/html/index.php">Home</a></li>
			<li><a></a></li>
			<!-- END MENU -->
         </ul>
